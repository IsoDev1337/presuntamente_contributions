...
- **Fase activa**: Fase 0 ✅ · Fase 1.0 (integración del design system) ✅ · Fase 1 MVP Plus Ultra (PR1 + PR2) ✅. **Fase 2 arrancada** con primer caso adicional: Begoña Gómez PR1 ✅.
- **Último hito**: PR1 del caso Begoña Gómez en main. Esqueleto completo: caso + NOTES + 5 personas (Begoña Gómez, Juan Carlos Peinado, Cristina Álvarez, Juan Carlos Barrabés, Joaquín Goyache) + 5 organizaciones nuevas (JI nº 41 Madrid, AP Madrid, UCM, Hazte Oír, Fiscalía Provincial Madrid) + 5 medios nuevos (Maldita.es, El Español, Moncloa.com, TheObjective, Noticias de Navarra) + 2 delitos nuevos del catálogo (corrupción en los negocios, apropiación indebida) + 8 documentos (2 autos judiciales N4 sin URL oficial localizada, citados vía cobertura cruzada V-13; 6 artículos N4) + 5 hitos + 6 hechos (4 atribuido + 2 exculpatorio) + 11 roles (4 pares investigada→procesada por el auto de 2026-04-13, 1 par investigado→desimputado del rector Goyache por la AP Madrid 2025-05-16, juez instructor, denunciante, acusación popular). `pnpm validate` 92 OK, `pnpm build` 40 páginas, `astro check` 0/0/0, ficha verificada con trayectoria de desimputación visible.
- **Próximo paso comprometido**: PR2 del caso Begoña Gómez con (a) acusaciones populares pendientes (Vox, Iustitia Europa, MRPE), (b) hito específico de imputación de Goyache (2024-10-29 según ampliación de delitos), (c) recurso de la Fiscalía ante la AP Madrid contra el auto de 2026-04-13, (d) anulación previa de la AP Madrid de 2026-02-23 sobre el envío a jurado popular, (e) UCM personada como perjudicada (2025-10-06). Alternativa: PR3 Plus Ultra si aparecen las fuentes oficiales pendientes (nota CGPJ del cambio_organo, comunicado UDEF, auto íntegro 19-may en CENDOJ).
...
- [x] **Begoña Gómez** PR1 (2026-05-22).
- [ ] Begoña Gómez PR2: acusaciones populares pendientes (Vox, Iustitia Europa, MRPE); hito de imputación específica de Goyache (2024-10-29); hito anulación AP Madrid de 2026-02-23; recurso de la Fiscalía ante AP Madrid contra el auto de 2026-04-13; UCM personada como perjudicada (2025-10-06); archive.org mirrors de los 6 documentos N4.
